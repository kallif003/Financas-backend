...
category_route
    ...
    .put(enum_1.Routes.UPDATE_CATEGORY, (0, middleware_1.verifyPermission)([enum_1.Permissions.USER]), category_controller.updateCategory)
    .delete(enum_1.Routes.DELETE_CATEGORY, (0, middleware_1.verifyPermission)([enum_1.Permissions.USER]), category_controller.deleteCategory);
