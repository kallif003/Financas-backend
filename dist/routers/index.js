...
const router = (app) => {
    ...
    app.use(express_1.default.json(), (0, cors_1.default)(), middleware_1.cacheControlMiddleware, login_route_1.default, users_route_1.default, middleware_1.verifyToken, salary_route_1.default, payload_route_1.default, category_route_1.default, refreshToken_route_1.default);
};
